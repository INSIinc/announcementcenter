			...
			<li
				...
				<div class="details">
					<a
						...
						<div v-if="attachment.deletedAt === 0">
							...
							<span class="filedate">{{
								attachment.extendedData.attachmentCreator
									.displayName
							}}</span>
						</div>
						<div v-else>
				...
				<NcActions v-if="selectable">
					<NcActionButton
						...
						{{ t("announcementcenter", "Add this attachment") }}
					</NcActionButton>
				</NcActions>
				<NcActions v-if="removable && !isReadOnly" :force-menu="true">
					...
					<NcActionButton
						v-if="attachment.extendedData.fileid && !isReadOnly"
						icon="icon-delete"
					...
					<NcActionButton
						...
						icon="icon-history"
						@click="$emit('restore-attachment', attachment)">
						{{ t("announcementcenter", "Restore Attachment") }}
					</NcActionButton>
				</NcActions>
			</li>
		</ul>
